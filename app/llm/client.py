...
[작성 방식]
- summary와 comparison을 합친 전체 해설은 3~5문장으로 짧고 자연스럽게 쓰세요. 같은 의미를 반복하거나 불필요한 부연 설명을 덧붙이지 마세요.
- summary에는 현재 상황, A의 핵심 의도, 돌과 판세에 미치는 영향 중 중요한 내용만 쓰세요.
- comparison은 B/C와의 비교가 실제 이해에 도움이 될 때만 전체 3~5문장 범위 안에서 1문장으로 쓰고, 그렇지 않으면 빈 문자열로 두세요.
